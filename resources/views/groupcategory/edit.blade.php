	...
	<div class="row">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<thead>
					  ...
					  <tbody>
					@foreach($groupcategoryAll as $category)
						<tr bgcolor="">
					    <td height="25" class="text-center">{{ $index++ }}</td>
					    <td height="25" align="left">{{ $category->name }}&nbsp;</td>
					    <td align="left" class="action text-center">
					    	{!! Form::open(array('url'=>route('groupcategory.destroy', array($category->id)),'method'=>'delete')) !!}
								<a href="{{route('groupcategory.edit', array($category->id))}}" class="btn btn-xs btn-success tooltip-top" title="Edit Category" style="padding:5px 10px 5px 10px;"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;&nbsp;
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					{!! Form::model($groupcategoryById,['route'=>['groupcategory.update',$groupcategoryById->id],'method'=>'patch','class'=>'form-horizontal']) !!}
