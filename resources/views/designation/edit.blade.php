...
<div class="container">
	<div class="row">
				...
				<div class="panel-body">
					...
					@foreach($designationAll as $designation)
					    ...
					    <td align="left" class="action text-center">
					    	{!! Form::model(array('url'=>route('designation.destroy', array($designation->id)),'method'=>'delete')) !!}
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				<div class="panel-heading"><strong>Edit Designation</strong></div>
				<div class="panel-body">
					<div class="col-md-12">
					{!! Form::model($designationById,['route'=>['designation.update',$designationById->id],'method'=>'patch','class'=>'form-horizontal']) !!}
						...
						<div class="form-group">
							...
							{!! Form::select('type',$type,$designationById->type,['class'=>'form-control']) !!}
							@if($errors->has('type'))
